...
const searchButton = document.querySelector(".search .js-search-btn");
const searchInput = document.querySelector(".search input[type=search]");
const clearButton = document.querySelector(".search .js-clear-btn");

if (searchContainer && searchButton && searchInput && clearButton) {
    ...
    function performSearch() {
        if (searchInput.value.trim() !== "") {
            ...
            hideSearch(); // Eingabefeld ausblenden
        }
    }
